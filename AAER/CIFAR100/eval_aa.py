...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str, default='train_fgsm_output/model.pth')
    ...
    # load attack    
    from robustness.robustbenchmaster.autoattack import AutoAttack
    ...
    if not args.individual:
        ...
        torch.save({'adv_complete': adv_complete}, '{}/{}_{}_1_{}_eps_{:.5f}.pth'.format(
            args.save_dir, 'aa', args.version, adv_complete.shape[0], epsilon))
